...
//   // Remember that jQuery has a .click() function:
...
//   audio.play();
// }
// function animatePress(currentColor) { $("#" + currentColor).addClass("pressed"); setTimeout(function () {   $("#" + currentColor).removeClass("pressed");
//   }, 100);
